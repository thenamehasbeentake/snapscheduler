...
//
//	import exectest "deeproute.ai/smd/pkg/util/exec/test"
...
func TestMockExecHelperProcess(t *testing.T) {
	...
	_, _ = fmt.Fprint(os.Stderr, os.Getenv("GO_HELPER_PROCESS_STDERR")) // return stderr before stdout
	_, _ = fmt.Fprint(os.Stdout, os.Getenv("GO_HELPER_PROCESS_STDOUT"))
